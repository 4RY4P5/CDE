...
{
    createMenu(foodMenu);
    //error 1: CHANGES DONE IN foodMenu BY editMenuAdmin() NOT REFLECTED IN foodMenu in this function
}
...
function addCart(carti)
{
    ...
    // error2 : ITEM NOT PUSHING INTO CART.
